...
#define CREATE_CLASS(classname) jojo::Factory::Instance().Create<jojo::classname>(#classname);
#define CREATE_CLASS_BASE(classbase,classname) jojo::Factory::Instance().Create<jojo::classbase>(classname);
#define INSTANTIATE(classbase,classname) jojo::Factory::Instance().Create<jojo::classbase>(classname);
